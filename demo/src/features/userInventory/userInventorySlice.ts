...
import {
  addProductToUserInventory,
  getUserInventory,
} from "../../api/GetFakeData";
...
export const addNewProduct = createAsyncThunk(
  "userInventory/addProductToInventory",
...
export const selectInventoryProducts = (state: RootState) =>
  state.userInventory.products;
export const selectInventoryStatus = (state: RootState) =>
  state.userInventory.status;
